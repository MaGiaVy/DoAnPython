...
1. Lịch sử làm việc trong tuần 5 
1. Tóm tắt quá trình từ tuần 1 đến tuần 4 
1. Dữ liệu cuối cùng và pipeline xử lý 
1. Baseline và kết quả baseline 
1. Phương pháp chính và các cải tiến đã triển khai 
1. Kết quả thực nghiệm cuối cùng 
1. So sánh baseline – phương pháp chính – mô hình tối ưu 
1. Phân tích lỗi và hạn chế 
1. Demo hoặc sản phẩm thử nghiệm 
1. Phân công, minh chứng cá nhân và khai báo sử dụng AI 
...
| :- | :- | :- | :- | :- |
|01–02/6|Thành viên A|Chạy lại toàn bộ pipeline, kiểm tra dữ liệu cuối|final\_pipeline.ipynb|Hoàn thành|
|02–03/6|Thành viên B|Chốt mô hình tốt nhất, tổng hợp metric|final\_results.csv, bảng metric|Hoàn thành|
|03–04/6|Thành viên C|Phân tích lỗi cuối cùng|error\_analysis.csv, hình minh họa|Hoàn thành|
|04–05/6|Cả nhóm|Chuẩn bị demo và báo cáo tuần 5|demo.py, report\_week5.docx|Hoàn thành|
...
1. Nhóm đã thử cách sửa nào? 
1. Nếu phát triển tiếp, nên cải thiện theo hướng nào? 
...
| :- | :- | :- | :- |
|Thành viên 1|Hoàn thiện dữ liệu, pipeline, EDA cuối|01\_final\_data\_pipeline.ipynb|Hoàn thành|
|Thành viên 2|Chốt mô hình, chạy kết quả cuối|02\_final\_model.ipynb, final\_results.csv|Hoàn thành|
|Thành viên 3|Phân tích lỗi, demo, báo cáo|03\_error\_demo.ipynb, demo.py, báo cáo|Hoàn thành|
...
NhomXX\_Tuan5/\
├── report/\
│   └── BaoCao\_Tuan5\_NhomXX.docx\
├── notebooks/\
│   ├── 01\_final\_data\_pipeline.ipynb\
│   ├── 02\_final\_model.ipynb\
│   └── 03\_error\_analysis\_demo.ipynb\
├── src/\
│   └── predict.py\
├── demo/\
...
│   └── sample\_input.csv\
├── slides/\
│   └── outline\_or\_slides\_week5.pptx\
├── README.md\
└── requirements.txt
...
1. Chốt một bảng kết quả cuối chính thức. 
1. Đảm bảo số liệu trong báo cáo khớp notebook/code. 
1. Hoàn thiện demo hoặc ví dụ chạy thử. 
1. Phân tích lỗi có mẫu cụ thể. 
1. Chuẩn bị dàn ý/slide thuyết trình 5–7 phút.
